...
<head>
	...
	<!-- Page level plugin styles BEGIN -->
      <link href="<%=basePath%>resources/plugin/metronic/assets/global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet">
      <!-- Page level plugin styles END -->
	  <!-- Theme styles BEGIN -->
  <link href="<%=basePath%>resources/plugin/metronic/assets/global/css/components.css" rel="stylesheet">
  <link href="<%=basePath%>resources/plugin/metronic/assets/onepage/css/style.css" rel="stylesheet">
  <link href="<%=basePath%>resources/plugin/metronic/assets/onepage/css/style-responsive.css" rel="stylesheet">
  <link href="<%=basePath%>resources/plugin/metronic/assets/onepage/css/themes/red.css" rel="stylesheet" id="style-color">
  <link href="<%=basePath%>resources/plugin/metronic/assets/onepage/css/custom.css" rel="stylesheet">
  <!-- Theme styles END -->
	<!-- 自定义 -->
...
<body>
	...
	<form action="<%=basePath%>upload/image" method="post" enctype="multipart/form-data">  
     ...
     <div class="container-fluid">
	     ...
	     <hr>
	     <!-- 图片展示 -->
	     <div id="imagesShow" class="portfolio-block content content-center">
	       <div class="container">
             <h2 class="margin-bottom-50">图片 <strong>展示</strong></h2>
           </div>
    ...
    <script src="<%=basePath%>resources/js/common/jqueryPlugin.js"></script>
     <!-- Core plugins BEGIN (required only for current page) 弹出框插件-->
  <script src="<%=basePath%>resources/plugin/metronic/assets/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script><!-- pop up -->
   <!-- Core plugins END (required only for current page) -->
   <!-- Global js BEGIN -->
  <script src="<%=basePath%>resources/plugin/metronic/assets/onepage/scripts/layout.js" type="text/javascript"></script>
   <script>
