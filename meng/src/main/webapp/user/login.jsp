  		...
  		<form class="form-horizontal loginForm" action="<%=path%>/j_spring_security_login" method="post" id="loginId">
  			<div class="form-group">
			    	<div class="input-group">
				      ...
				      <input value="12345@qq.com" type="text" name="j_username" class="form-control JV_Required" id="inputName" placeholder="请输入账号[邮箱]" aria-describedby="basic-addon1">		      
			    	</div>
			</div>
		  <div class="form-group">
		    	<div class="input-group">
				    <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>  					
		      		<input value="123456" type="password" name="j_password" class="form-control JV_Required JV_Password" id="inputPassword" placeholder="请输入密码" aria-describedby="basic-addon2">
		      	</div>
		  </div>
